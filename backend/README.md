...
## Project Structure
    ...
    ├── getting_started_rya_39767  # Django project configurations
...
1. Clone this repo and `cd getting_started_rya_39767`
...
2. Clone this repo and `cd getting_started_rya_39767`
